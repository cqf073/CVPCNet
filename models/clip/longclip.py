...
def load_from_clip(name: str, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu",
...
def tokenize(texts: Union[str, List[str]], context_length: int = 77 * 4 - 60, truncate: bool = False) -> Union[
